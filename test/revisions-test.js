        ...
        request(app)
          ...
          .end(function (err, res) {
            ...
            revisions.find({order: 'id ASC'}, function(err, revs) {
              ...
              tt.equal(rev.ip, '127.0.0.1');
              tt.equal(rev.ip_forwarded, '127.0.0.1');
            ...
            request(app)
              ...
              .end(function (err, res) {
                ...
                revisions.find({order: 'id ASC'}, function(err, revs) {
                  ...
                  tt.equal(revs[0].ip, '127.0.0.1');
                  tt.equal(revs[0].ip_forwarded, '127.0.0.1');
                  ...
                  tt.equal(revs[1].ip, '127.0.0.1');
                  tt.equal(revs[1].ip_forwarded, '127.0.0.1');
                ...
                request(app)
                  ...
                  .end(function (err, res) {
                    ...
                    revisions.find({order: 'id ASC'}, function(err, revs) {
                      ...
                      tt.equal(revs[2].ip, '127.0.0.1');
                      tt.equal(revs[2].ip_forwarded, '127.0.0.1');
